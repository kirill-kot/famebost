(function () {
    ...
    Slider.prototype.addStyle = function () {
        ...
        var currentImg = $('.slides-holder__item_active').find('img').attr('src');
        var currColor =  $('.slides-holder__item_active').attr('class').match(/(^|\s)bg-\S+/g);
        $('.icon-holder').attr('class', 'icon-holder' + currColor[0]);
        $('.icon-holder .shade').attr('class', 'shade' + currColor[0]);
        $('.icon-holder .shade2').attr('class', 'shade2' + currColor[0]);
        $('.icon-holder img').attr('src', currentImg);
    };
